...
# static fields
.field public static final enum sJ:Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;

.field public static final enum sK:Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;

.field private static final synthetic sL:[Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;->sJ:Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;
    ...
    sput-object v3, Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;->sK:Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;
    ...
    sput-object v0, Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;->sL:[Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;
...
.method static synthetic a(Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;Lcom/android/settings/fh;)I
    .locals 1

    .prologue
    .line 67
    invoke-direct {p0, p1}, Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;->j(Lcom/android/settings/fh;)I
...
.method static synthetic a(Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;ZLcom/android/settings/fh;)V
    .locals 0

    .prologue
    .line 67
    invoke-direct {p0, p1, p2}, Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;->a(ZLcom/android/settings/fh;)V

    return-void
.end method

.method private a(ZLcom/android/settings/fh;)V
    .locals 1
    ...
    .line 126
    invoke-static {p2}, Lcom/android/settings/fh;->c(Lcom/android/settings/fh;)Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;
    ...
    .line 127
    invoke-static {p2}, Lcom/android/settings/fh;->b(Lcom/android/settings/fh;)Z
    ...
    :goto_0
    invoke-static {p2, v0}, Lcom/android/settings/fh;->a(Lcom/android/settings/fh;Z)Z

    .line 131
    :goto_1
    invoke-static {p2}, Lcom/android/settings/fh;->d(Lcom/android/settings/fh;)Lcom/android/settings/fi;
    ...
    invoke-static {v0}, Lcom/android/settings/fi;->b(Lcom/android/settings/fi;)V
...
.method private a(Lcom/android/org/conscrypt/TrustedCertificateStore;Ljava/lang/String;)Z
    ...
    .line 92
    sget-object v1, Lcom/android/settings/ff;->sy:[I
...
.method static synthetic b(Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;Lcom/android/settings/fh;)I
    .locals 1

    .prologue
    .line 67
    invoke-direct {p0, p1}, Lcom/android/settings/MiuiSecurityTrustedCredentials$Tab;->k(Lcom/android/settings/fh;)I
...
.method private j(Lcom/android/settings/fh;)I
    .locals 2
    ...
    .line 103
    :pswitch_0
    invoke-static {p1}, Lcom/android/settings/fh;->b(Lcom/android/settings/fh;)Z
...
.method private k(Lcom/android/settings/fh;)I
    .locals 2
