...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->Xy:Landroid/widget/CompoundButton$OnCheckedChangeListener;
...
.method static synthetic a(Lcom/android/settings/deviceinfo/StorageWizardMigrate;)Landroid/widget/RadioButton;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XB:Landroid/widget/RadioButton;
...
.method static synthetic b(Lcom/android/settings/deviceinfo/StorageWizardMigrate;)Landroid/widget/RadioButton;
    ...
    .prologue
    .line 28
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XC:Landroid/widget/RadioButton;
...
.method public hY()V
    ...
    iget-object v2, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->Vv:Landroid/os/storage/DiskInfo;
    ...
    .line 86
    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XA:Lcom/android/settings/deviceinfo/MigrateEstimateTask;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 37
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->Vv:Landroid/os/storage/DiskInfo;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XB:Landroid/widget/RadioButton;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XC:Landroid/widget/RadioButton;

    .line 50
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XB:Landroid/widget/RadioButton;

    iget-object v1, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->Xy:Landroid/widget/CompoundButton$OnCheckedChangeListener;
    ...
    iput-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XA:Lcom/android/settings/deviceinfo/MigrateEstimateTask;

    .line 63
    iget-object v0, p0, Lcom/android/settings/deviceinfo/StorageWizardMigrate;->XA:Lcom/android/settings/deviceinfo/MigrateEstimateTask;
