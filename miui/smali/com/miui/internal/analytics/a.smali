...
.field private static final e:Ljava/lang/String; = "analytics.db"

.field private static final f:Ljava/lang/String; = "analytics"

.field private static final g:Ljava/lang/String; = "create table analytics (_id integer primary key autoincrement,_time datetime,_status integer,package text,type integer,event_id text,param text,time text,value text)"

.field private static final h:Ljava/lang/String; = "insert into analytics values (null, datetime(\'now\'), 0, ?, ?, ?, ?, ?, ?)"

.field private static final i:Ljava/lang/String; = "delete from analytics where _time < datetime(\'now\', \'-7 days\')"

.field private static final j:Ljava/lang/String; = "update analytics set _status = 0"

.field private static final k:Ljava/lang/String; = "update analytics set _status = 1 where (_time < datetime(date(datetime(\'now\'))))"

.field private static final l:Ljava/lang/String; = "delete from analytics where _status = 1"

.field private static final m:Ljava/lang/String; = "select * from analytics where _status = 1"
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 64
    new-instance v0, Lcom/miui/internal/analytics/a$2;

    invoke-direct {v0}, Lcom/miui/internal/analytics/a$2;-><init>()V

    sput-object v0, Lcom/miui/internal/analytics/a;->p:Lmiui/util/SoftReferenceSingleton;
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/miui/internal/analytics/a;->o:Landroid/database/sqlite/SQLiteOpenHelper;
...
.method public static a()Lcom/miui/internal/analytics/a;
    ...
    .prologue
    .line 73
    sget-object v0, Lcom/miui/internal/analytics/a;->p:Lmiui/util/SoftReferenceSingleton;
...
.method public a(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 93
    :try_start_0
    iget-object v1, p0, Lcom/miui/internal/analytics/a;->o:Landroid/database/sqlite/SQLiteOpenHelper;
    ...
    iget-object v6, p0, Lcom/miui/internal/analytics/a;->o:Landroid/database/sqlite/SQLiteOpenHelper;
...
.method public a(Ljava/lang/String;Ljava/lang/Integer;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 78
    :try_start_0
    iget-object v0, p0, Lcom/miui/internal/analytics/a;->o:Landroid/database/sqlite/SQLiteOpenHelper;
    ...
    iget-object v3, p0, Lcom/miui/internal/analytics/a;->o:Landroid/database/sqlite/SQLiteOpenHelper;
...
.method public b()V
    ...
    iget-object v4, p0, Lcom/miui/internal/analytics/a;->o:Landroid/database/sqlite/SQLiteOpenHelper;
