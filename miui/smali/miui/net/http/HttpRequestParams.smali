...
# instance fields
.field private Bw:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmiui/net/http/HttpRequestParams;->xX:Ljava/lang/String;
    ...
    iput-object v0, p0, Lmiui/net/http/HttpRequestParams;->Bw:Ljava/util/concurrent/ConcurrentHashMap;

    .line 55
    const/4 v0, 0x0

    iput-boolean v0, p0, Lmiui/net/http/HttpRequestParams;->Bx:Z
...
.method private cm()Ljava/util/List;
    ...
    .line 255
    iget-object v0, p0, Lmiui/net/http/HttpRequestParams;->Bw:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public add(Ljava/lang/String;Ljava/io/File;)Lmiui/net/http/HttpRequestParams;
    ...
    .line 123
    :try_start_0
    iget-object v6, p0, Lmiui/net/http/HttpRequestParams;->Bw:Ljava/util/concurrent/ConcurrentHashMap;
...
.method getEntity()Lorg/apache/http/HttpEntity;
    ...
    .line 237
    :try_start_0
    iget-boolean v0, p0, Lmiui/net/http/HttpRequestParams;->Bx:Z
    ...
    iget-object v2, p0, Lmiui/net/http/HttpRequestParams;->xX:Ljava/lang/String;

    iget-object v3, p0, Lmiui/net/http/HttpRequestParams;->Bw:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0, v2, v3}, Lmiui/net/http/c;-><init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-direct {p0}, Lmiui/net/http/HttpRequestParams;->cm()Ljava/util/List;

    move-result-object v2

    iget-object v3, p0, Lmiui/net/http/HttpRequestParams;->xX:Ljava/lang/String;
...
.method public getParamString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lmiui/net/http/HttpRequestParams;->xX:Ljava/lang/String;
...
.method public setEncoding(Ljava/lang/String;)Lmiui/net/http/HttpRequestParams;
    ...
    :cond_0
    iput-object p1, p0, Lmiui/net/http/HttpRequestParams;->xX:Ljava/lang/String;
