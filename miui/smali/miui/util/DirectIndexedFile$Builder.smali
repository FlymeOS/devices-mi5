...
# instance fields
.field private Gb:Lmiui/util/DirectIndexedFile$d;
...
.field private Gd:Lmiui/util/DirectIndexedFile$Builder$b;
...
.method private constructor <init>(I)V
    ...
    iput-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gc:Ljava/util/ArrayList;

    .line 1190
    iput p1, p0, Lmiui/util/DirectIndexedFile$Builder;->Ge:I
...
.method private a(Ljava/io/DataOutput;)I
    ...
    .line 1437
    :goto_0
    iget-object v1, p0, Lmiui/util/DirectIndexedFile$Builder;->Gb:Lmiui/util/DirectIndexedFile$d;

    invoke-static {v1}, Lmiui/util/DirectIndexedFile$d;->a(Lmiui/util/DirectIndexedFile$d;)[Lmiui/util/DirectIndexedFile$c;
    ...
    .line 1439
    iget-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gb:Lmiui/util/DirectIndexedFile$d;
    ...
    invoke-static {v0, v4, v5}, Lmiui/util/DirectIndexedFile$c;->a(Lmiui/util/DirectIndexedFile$c;J)J

    .line 1441
    iget-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gc:Ljava/util/ArrayList;
    ...
    .line 1443
    invoke-static {v0}, Lmiui/util/DirectIndexedFile$Builder$b;->e(Lmiui/util/DirectIndexedFile$Builder$b;)[Lmiui/util/DirectIndexedFile$e;
    ...
    invoke-static {v1, v6, v7}, Lmiui/util/DirectIndexedFile$c;->b(Lmiui/util/DirectIndexedFile$c;J)J
    ...
    iput-wide v6, v5, Lmiui/util/DirectIndexedFile$e;->Gx:J
    ...
    iget v5, v5, Lmiui/util/DirectIndexedFile$e;->Hg:I
    ...
    iget v7, v7, Lmiui/util/DirectIndexedFile$e;->Hf:I
    ...
    iget v5, v5, Lmiui/util/DirectIndexedFile$e;->Hf:I
    ...
    iget v1, v1, Lmiui/util/DirectIndexedFile$e;->Hg:I
    ...
    invoke-interface {p1, v10, v11}, Ljava/io/DataOutput;->writeLong(J)V
...
.method private cO()V
    ...
    .prologue
    .line 1390
    iget-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gd:Lmiui/util/DirectIndexedFile$Builder$b;
...
.method private cP()V
    ...
    .prologue
    .line 1396
    invoke-direct {p0}, Lmiui/util/DirectIndexedFile$Builder;->cO()V
...
.method private cQ()V
    ...
    iget v1, p0, Lmiui/util/DirectIndexedFile$Builder;->Ge:I

    const/4 v2, 0x0

    invoke-direct {v0, v9, v1, v2}, Lmiui/util/DirectIndexedFile$d;-><init>(IILmiui/util/DirectIndexedFile$1;)V

    iput-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gb:Lmiui/util/DirectIndexedFile$d;
    ...
    new-instance v1, Lmiui/util/DirectIndexedFile$c;
    ...
    invoke-direct/range {v1 .. v6}, Lmiui/util/DirectIndexedFile$c;-><init>(JJLmiui/util/DirectIndexedFile$1;)V
    ...
    .line 1417
    :cond_0
    new-array v1, v2, [Lmiui/util/DirectIndexedFile$e;

    invoke-static {v0, v1}, Lmiui/util/DirectIndexedFile$Builder$b;->a(Lmiui/util/DirectIndexedFile$Builder$b;[Lmiui/util/DirectIndexedFile$e;)[Lmiui/util/DirectIndexedFile$e;
    ...
    check-cast v2, Lmiui/util/DirectIndexedFile$Builder$c;

    invoke-static {v2}, Lmiui/util/DirectIndexedFile$Builder$c;->b(Lmiui/util/DirectIndexedFile$Builder$c;)I
    ...
    new-instance v1, Lmiui/util/DirectIndexedFile$e;

    const-wide/16 v4, 0x0

    const/4 v6, 0x0

    invoke-direct/range {v1 .. v6}, Lmiui/util/DirectIndexedFile$e;-><init>(IIJLmiui/util/DirectIndexedFile$1;)V
    ...
    :try_start_0
    invoke-direct {p0, v0}, Lmiui/util/DirectIndexedFile$Builder;->a(Ljava/io/DataOutput;)I
    :try_end_0
...
.method public varargs add(I[Ljava/lang/Object;)V
    ...
    .prologue
    .line 1282
    invoke-direct {p0}, Lmiui/util/DirectIndexedFile$Builder;->cP()V
    ...
    iget-object v2, p0, Lmiui/util/DirectIndexedFile$Builder;->Gd:Lmiui/util/DirectIndexedFile$Builder$b;
    ...
    .line 1290
    sget-object v0, Lmiui/util/DirectIndexedFile$1;->Ga:[I
    ...
    iget-object v3, p0, Lmiui/util/DirectIndexedFile$Builder;->Gd:Lmiui/util/DirectIndexedFile$Builder$b;
    ...
    invoke-static {v0}, Lmiui/util/DirectIndexedFile$DataItemDescriptor;->Q(I)B
...
.method public varargs addKind([Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v1, v8}, Lmiui/util/DirectIndexedFile$Builder$b;-><init>(ILmiui/util/DirectIndexedFile$1;)V

    iput-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gd:Lmiui/util/DirectIndexedFile$Builder$b;

    .line 1199
    iget-object v0, p0, Lmiui/util/DirectIndexedFile$Builder;->Gc:Ljava/util/ArrayList;

    iget-object v1, p0, Lmiui/util/DirectIndexedFile$Builder;->Gd:Lmiui/util/DirectIndexedFile$Builder$b;
    ...
    invoke-direct {v1, p0, v8}, Lmiui/util/DirectIndexedFile$Builder$a;-><init>(Lmiui/util/DirectIndexedFile$Builder;Lmiui/util/DirectIndexedFile$1;)V
    ...
    .line 1207
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->Gy:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    invoke-static {v0, v1}, Lmiui/util/DirectIndexedFile$Builder$a;->a(Lmiui/util/DirectIndexedFile$Builder$a;Ljava/lang/Object;)Ljava/lang/Integer;
    ...
    .line 1211
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->Gz:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1215
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GC:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1219
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GJ:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1223
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GK:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1226
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GO:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1229
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GP:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1232
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GS:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    .line 1235
    sget-object v2, Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;->GV:Lmiui/util/DirectIndexedFile$DataItemDescriptor$Type;
    ...
    invoke-direct {v1, p0, v2, p1, v8}, Lmiui/util/DirectIndexedFile$Builder$c;-><init>(Lmiui/util/DirectIndexedFile$Builder;I[Ljava/lang/Object;Lmiui/util/DirectIndexedFile$1;)V
...
.method public write(Ljava/lang/String;)V
    ...
    .prologue
    .line 1368
    invoke-direct {p0}, Lmiui/util/DirectIndexedFile$Builder;->cQ()V
