...
.field private IF:Lmiui/util/async/Task$Priority;

.field private IG:Ljava/lang/Thread;

.field private IH:Ljava/util/HashSet;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashSet",
            "<",
...
.field private final II:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private volatile IJ:Lmiui/util/async/Task$Status;
...
.method public constructor <init>(Lmiui/util/async/Task$Priority;)V
    ...
    iput-object v0, p0, Lmiui/util/async/Task;->II:Ljava/util/concurrent/atomic/AtomicBoolean;

    .line 215
    sget-object v0, Lmiui/util/async/Task$Status;->New:Lmiui/util/async/Task$Status;

    iput-object v0, p0, Lmiui/util/async/Task;->IJ:Lmiui/util/async/Task$Status;

    .line 216
    iput-object p1, p0, Lmiui/util/async/Task;->IF:Lmiui/util/async/Task$Priority;
...
.method private a(Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
    ...
    .prologue
    .line 413
    iget-object v0, p0, Lmiui/util/async/Task;->IC:Ljava/lang/ref/WeakReference;
...
.method private b(Lmiui/util/async/TaskManager;)V
    ...
    .prologue
    .line 361
    iget-object v1, p0, Lmiui/util/async/Task;->II:Ljava/util/concurrent/atomic/AtomicBoolean;

    monitor-enter v1

    .line 362
    :try_start_0
    iget-object v0, p0, Lmiui/util/async/Task;->IH:Ljava/util/HashSet;
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, Lmiui/util/async/Task;->II:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private dl()Z
    ...
    .line 382
    iget-object v0, p0, Lmiui/util/async/Task;->IJ:Lmiui/util/async/Task$Status;
    ...
    .line 383
    iget-object v2, p0, Lmiui/util/async/Task;->II:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 393
    invoke-direct {v0}, Lmiui/util/async/Task;->dl()Z
...
.method final a(Ljava/lang/Thread;)V
    ...
    .prologue
    .line 326
    iput-object p1, p0, Lmiui/util/async/Task;->IG:Ljava/lang/Thread;

    .line 327
    if-eqz p1, :cond_0

    .line 328
    sget-object v0, Lmiui/util/async/Task$1;->IP:[I

    iget-object v1, p0, Lmiui/util/async/Task;->IF:Lmiui/util/async/Task$Priority;
...
.method final a(Lmiui/util/async/Task$Status;Ljava/lang/Object;)V
    ...
    .line 226
    sget-object v0, Lmiui/util/async/Task$1;->IK:[I

    iget-object v1, p0, Lmiui/util/async/Task;->IJ:Lmiui/util/async/Task$Status;
    ...
    :goto_0
    :pswitch_0
    iput-object p1, p0, Lmiui/util/async/Task;->IJ:Lmiui/util/async/Task$Status;
    ...
    .line 230
    :pswitch_2
    sget-object v0, Lmiui/util/async/Task$Delivery;->IV:Lmiui/util/async/Task$Delivery;
    ...
    .line 233
    :pswitch_3
    sget-object v0, Lmiui/util/async/Task$Delivery;->IW:Lmiui/util/async/Task$Delivery;

    invoke-direct {p0, v0, v2}, Lmiui/util/async/Task;->a(Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V

    .line 234
    sget-object v0, Lmiui/util/async/Task$Delivery;->IY:Lmiui/util/async/Task$Delivery;
...
.method final a(Lmiui/util/async/TaskManager;Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
    ...
    .prologue
    .line 443
    sget-object v0, Lmiui/util/async/Task$1;->IU:[I
...
.method final a(Lmiui/util/async/TaskManager;)Z
    ...
    iput-object v0, p0, Lmiui/util/async/Task;->IC:Ljava/lang/ref/WeakReference;
...
.method public final depends(Lmiui/util/async/Task;)V
    ...
    .line 662
    iget-object v0, p1, Lmiui/util/async/Task;->IH:Ljava/util/HashSet;
    ...
    iput-object v0, p1, Lmiui/util/async/Task;->IH:Ljava/util/HashSet;
...
.method public final getPriority()Lmiui/util/async/Task$Priority;
    ...
    .prologue
    .line 685
    iget-object v0, p0, Lmiui/util/async/Task;->IF:Lmiui/util/async/Task$Priority;
...
.method public final publishProgress(II)V
    ...
    .prologue
    .line 600
    sget-object v0, Lmiui/util/async/Task$Delivery;->IX:Lmiui/util/async/Task$Delivery;
...
.method public final restart()Z
    ...
    .line 721
    invoke-direct {p0}, Lmiui/util/async/Task;->dl()Z
...
.method public final setPriority(Lmiui/util/async/Task$Priority;)Lmiui/util/async/Task;
    ...
    iput-object v1, p0, Lmiui/util/async/Task;->IJ:Lmiui/util/async/Task$Status;
    ...
    .line 705
    iget-object v0, p0, Lmiui/util/async/Task;->IG:Ljava/lang/Thread;
