...
.field static final Jm:Z = true

.field static final Jn:Z = true

.field static final Jo:Z = false

.field static final Jp:Z = false

.field static final Jq:Z = false

.field private static final Jr:I = 0xa
...
.field private Jv:Lmiui/util/cache/Cache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private Jw:Lmiui/util/async/a;
...
.field private zx:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/async/TaskManager;->p:Lmiui/util/SoftReferenceSingleton;
...
.method public constructor <init>(III)V
    ...
    iput-object v1, p0, Lmiui/util/async/TaskManager;->zx:Ljava/lang/Object;

    .line 141
    iput-boolean v0, p0, Lmiui/util/async/TaskManager;->Jt:Z
    ...
    iput-object v1, p0, Lmiui/util/async/TaskManager;->Ju:Lmiui/util/async/b;
    ...
    iput-object v1, p0, Lmiui/util/async/TaskManager;->Jx:Ljava/util/ArrayList;
    ...
    .line 153
    iget-object v0, p0, Lmiui/util/async/TaskManager;->Jx:Ljava/util/ArrayList;

    new-instance v2, Lmiui/util/async/c;

    iget-object v3, p0, Lmiui/util/async/TaskManager;->Ju:Lmiui/util/async/b;

    invoke-direct {v2, p0, v3, v1}, Lmiui/util/async/c;-><init>(Lmiui/util/async/TaskManager;Lmiui/util/async/b;I)V
    ...
    check-cast v0, Lmiui/util/async/c;

    invoke-virtual {v0}, Lmiui/util/async/c;->start()V
    ...
    .line 157
    :cond_1
    new-instance v0, Lmiui/util/async/a;

    invoke-direct {v0, p0}, Lmiui/util/async/a;-><init>(Lmiui/util/async/TaskManager;)V

    iput-object v0, p0, Lmiui/util/async/TaskManager;->Jw:Lmiui/util/async/a;
    ...
    iput-object v0, p0, Lmiui/util/async/TaskManager;->Jv:Lmiui/util/cache/Cache;
...
.method private do()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lmiui/util/async/TaskManager;->Ju:Lmiui/util/async/b;
...
.method public static getDefault()Lmiui/util/async/TaskManager;
    ...
    .prologue
    .line 165
    sget-object v0, Lmiui/util/async/TaskManager;->p:Lmiui/util/SoftReferenceSingleton;
...
.method public add(Lmiui/util/async/Task;)V
    ...
    .line 219
    iget-boolean v0, p0, Lmiui/util/async/TaskManager;->Jt:Z
    ...
    .line 248
    :cond_3
    iget-object v0, p0, Lmiui/util/async/TaskManager;->Jv:Lmiui/util/cache/Cache;
    ...
    .line 249
    iget-object v1, p0, Lmiui/util/async/TaskManager;->Jv:Lmiui/util/cache/Cache;
    ...
    .line 266
    invoke-static {p0, p1}, Lmiui/util/async/c;->a(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
...
.method b(Lmiui/util/async/Task;Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V
    ...
    .prologue
    .line 375
    iget-object v0, p0, Lmiui/util/async/TaskManager;->Jw:Lmiui/util/async/a;

    invoke-virtual {v0, p1, p2, p3}, Lmiui/util/async/a;->a(Lmiui/util/async/Task;Lmiui/util/async/Task$Delivery;Ljava/lang/Object;)V

    .line 376
    return-void
.end method

.method dp()Lmiui/util/cache/Cache;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public setCallbackThread(Z)V
    ...
    invoke-virtual {v0, p1}, Lmiui/util/async/a;->setCallbackThread(Z)V
...
.method public setThreadCount(I)V
    ...
    .line 200
    new-instance v1, Lmiui/util/async/c;

    iget-object v2, p0, Lmiui/util/async/TaskManager;->Ju:Lmiui/util/async/b;

    invoke-direct {v1, p0, v2, v0}, Lmiui/util/async/c;-><init>(Lmiui/util/async/TaskManager;Lmiui/util/async/b;I)V

    .line 201
    invoke-virtual {v1}, Lmiui/util/async/c;->start()V

    .line 202
    iget-object v2, p0, Lmiui/util/async/TaskManager;->Jx:Ljava/util/ArrayList;
    ...
    .line 207
    invoke-virtual {v0}, Lmiui/util/async/c;->shutdown()V
...
.method public shutdown()V
    ...
    .line 317
    invoke-direct {p0}, Lmiui/util/async/TaskManager;->do()V
