...
# instance fields
.field private JZ:Landroid/graphics/BitmapFactory$Options;
...
.method public constructor <init>(Lmiui/net/http/HttpSession;Lmiui/util/async/tasks/HttpTask$Method;Ljava/lang/String;Ljava/util/Map;Landroid/graphics/BitmapFactory$Options;)V
    ...
    .line 69
    iput-object p5, p0, Lmiui/util/async/tasks/HttpBitmapTask;->JZ:Landroid/graphics/BitmapFactory$Options;
...
.method public doLoad()Landroid/graphics/Bitmap;
    ...
    .line 94
    sget-object v0, Lmiui/util/async/tasks/FileBitmapTask;->Ka:Ljava/util/concurrent/Semaphore;

    invoke-virtual {v0}, Ljava/util/concurrent/Semaphore;->acquireUninterruptibly()V

    .line 96
    :try_start_0
    invoke-interface {v1}, Lmiui/net/http/HttpResponse;->getContent()Ljava/io/InputStream;

    move-result-object v0

    const/4 v2, 0x0

    iget-object v3, p0, Lmiui/util/async/tasks/HttpBitmapTask;->JZ:Landroid/graphics/BitmapFactory$Options;

    invoke-static {v0, v2, v3}, Lmiui/graphics/BitmapFactory;->decodeStream(Ljava/io/InputStream;Landroid/graphics/Rect;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    :try_end_0
    ...
    .line 98
    invoke-interface {v1}, Lmiui/net/http/HttpResponse;->release()V

    .line 99
    sget-object v1, Lmiui/util/async/tasks/FileBitmapTask;->Ka:Ljava/util/concurrent/Semaphore;
