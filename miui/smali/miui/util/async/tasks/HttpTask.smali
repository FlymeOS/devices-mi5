...
.field private final Kc:Lmiui/net/http/HttpSession;

.field private final Kd:Lmiui/util/async/tasks/HttpTask$Method;

.field private final Ke:Ljava/lang/String;

.field private final Kf:Lmiui/net/http/HttpRequestParams;
...
.method public constructor <init>(Lmiui/net/http/HttpSession;Lmiui/util/async/tasks/HttpTask$Method;Ljava/lang/String;Ljava/util/Map;)V
    ...
    .line 92
    :cond_0
    iput-object p1, p0, Lmiui/util/async/tasks/HttpTask;->Kc:Lmiui/net/http/HttpSession;

    .line 93
    iput-object p2, p0, Lmiui/util/async/tasks/HttpTask;->Kd:Lmiui/util/async/tasks/HttpTask$Method;
    ...
    :goto_0
    iput-object v0, p0, Lmiui/util/async/tasks/HttpTask;->Ke:Ljava/lang/String;

    .line 102
    :goto_1
    const/4 v0, 0x0

    iput-object v0, p0, Lmiui/util/async/tasks/HttpTask;->Kf:Lmiui/net/http/HttpRequestParams;
    ...
    .line 100
    :cond_2
    iput-object p3, p0, Lmiui/util/async/tasks/HttpTask;->Ke:Ljava/lang/String;
    ...
    .line 106
    iget-object v0, p0, Lmiui/util/async/tasks/HttpTask;->Kf:Lmiui/net/http/HttpRequestParams;
...
.method public getDescription()Ljava/lang/String;
    ...
    .prologue
    .line 112
    iget-object v0, p0, Lmiui/util/async/tasks/HttpTask;->Ke:Ljava/lang/String;
...
.method protected final request()Lmiui/net/http/HttpResponse;
    ...
    .line 121
    iget-object v1, p0, Lmiui/util/async/tasks/HttpTask;->Ce:Lmiui/net/http/HttpSession$ProgressListener;
    ...
    iput-object v1, p0, Lmiui/util/async/tasks/HttpTask;->Ce:Lmiui/net/http/HttpSession$ProgressListener;

    .line 135
    :cond_0
    sget-object v1, Lmiui/util/async/tasks/HttpTask$2;->Kh:[I

    iget-object v2, p0, Lmiui/util/async/tasks/HttpTask;->Kd:Lmiui/util/async/tasks/HttpTask$Method;
    ...
    .line 137
    :pswitch_0
    iget-object v1, p0, Lmiui/util/async/tasks/HttpTask;->Kc:Lmiui/net/http/HttpSession;

    iget-object v2, p0, Lmiui/util/async/tasks/HttpTask;->Ke:Ljava/lang/String;

    iget-object v3, p0, Lmiui/util/async/tasks/HttpTask;->Kf:Lmiui/net/http/HttpRequestParams;

    iget-object v4, p0, Lmiui/util/async/tasks/HttpTask;->Ce:Lmiui/net/http/HttpSession$ProgressListener;
