...
# static fields
.field private static final Kk:Ljava/util/LinkedHashSet;
...
# instance fields
.field private final Kl:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private Km:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/lang/ref/WeakReference",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kk:Ljava/util/LinkedHashSet;
...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    iput-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kl:Ljava/lang/ref/WeakReference;
...
.method private a(Lmiui/util/async/tasks/listeners/ImageViewBindingListener;)Z
    ...
    .prologue
    .line 99
    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kl:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object v0

    iget-object v1, p1, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kl:Ljava/lang/ref/WeakReference;
...
.method public onException(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;Ljava/lang/Exception;)V
    ...
    .prologue
    .line 174
    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Ko:Landroid/graphics/drawable/Drawable;
    ...
    .line 177
    iget-object v1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Ko:Landroid/graphics/drawable/Drawable;
...
.method public onFinalize(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    .prologue
    .line 184
    sget-object v0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kk:Ljava/util/LinkedHashSet;
...
.method public onPrepare(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    .prologue
    .line 111
    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Km:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Km:Ljava/lang/ref/WeakReference;
    ...
    .line 122
    iget-object v0, v0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Km:Ljava/lang/ref/WeakReference;
    ...
    .line 132
    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kn:Landroid/graphics/drawable/Drawable;
    ...
    .line 135
    iget-object v1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kn:Landroid/graphics/drawable/Drawable;
...
.method public setErrorDrawable(Landroid/graphics/drawable/Drawable;)Lmiui/util/async/tasks/listeners/ImageViewBindingListener;
    ...
    .prologue
    .line 87
    iput-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Ko:Landroid/graphics/drawable/Drawable;
...
.method public setPlaceHolderDrawable(Landroid/graphics/drawable/Drawable;)Lmiui/util/async/tasks/listeners/ImageViewBindingListener;
    ...
    .prologue
    .line 75
    iput-object p1, p0, Lmiui/util/async/tasks/listeners/ImageViewBindingListener;->Kn:Landroid/graphics/drawable/Drawable;
