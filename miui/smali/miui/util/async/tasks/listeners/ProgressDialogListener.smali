...
# static fields
.field static final Kp:Ljava/util/LinkedHashMap;
...
.field Km:Ljava/lang/ref/WeakReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field Kq:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;

.field bo:Landroid/app/FragmentManager;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kp:Ljava/util/LinkedHashMap;
...
.method public constructor <init>(Landroid/app/FragmentManager;)V
    ...
    .line 53
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->vW:I

    .line 58
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Ct:I

    .line 63
    iput-object v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->mTitle:Ljava/lang/CharSequence;

    .line 68
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Cu:I
    ...
    .line 83
    iput-boolean v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ww:Z

    .line 88
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Cv:I

    .line 93
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->wm:I

    .line 98
    iput v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->fa:I

    .line 106
    iput-object p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->bo:Landroid/app/FragmentManager;
...
.method public onFinalize(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    .prologue
    .line 277
    iget-object v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kq:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
    ...
    .line 280
    :cond_0
    sget-object v0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kp:Ljava/util/LinkedHashMap;
...
.method public onPrepare(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;)V
    ...
    iput-object v0, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Km:Ljava/lang/ref/WeakReference;
    ...
    .line 227
    sget-object v1, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kp:Ljava/util/LinkedHashMap;
    ...
    iput-object v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kq:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
    ...
    .line 231
    iget-object v2, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kq:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;
    ...
    .line 232
    iget-object v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kq:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;

    iget-object v2, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->bo:Landroid/app/FragmentManager;
    ...
    .line 235
    iput-object v3, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Kq:Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;

    .line 236
    iput-object v3, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->bo:Landroid/app/FragmentManager;
...
.method public onProgress(Lmiui/util/async/TaskManager;Lmiui/util/async/Task;II)V
    ...
    .line 245
    iget-boolean v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ww:Z
    ...
    .line 259
    :cond_2
    iget v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Cv:I
    ...
    invoke-virtual {v0, v1}, Lmiui/util/async/tasks/listeners/ProgressDialogListener$ProgressDialogFragment;->T(I)V

    .line 266
    :cond_3
    iget v1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->fa:I

    if-eq v1, p4, :cond_0

    .line 267
    iput p4, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->fa:I
...
.method public setIndeterminate(Z)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    .prologue
    .line 205
    iput-boolean p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->ww:Z
...
.method public setMaxProgress(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    .prologue
    .line 217
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Cv:I
...
.method public setMessage(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    .prologue
    .line 155
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Cu:I
...
.method public setProgressStyle(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    .prologue
    .line 193
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->wm:I
...
.method public setTheme(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    .prologue
    .line 117
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->vW:I
...
.method public setTitle(I)Lmiui/util/async/tasks/listeners/ProgressDialogListener;
    ...
    .prologue
    .line 129
    iput p1, p0, Lmiui/util/async/tasks/listeners/ProgressDialogListener;->Ct:I
